...
export class ScaHunter {
    ...
    phase1System = `You are a reachability analysis expert for supply chain vulnerabilities.
...
Return results as JSON with this structure:
{
  "findings": [
    ...
    phase2System = `You are a reachability analysis expert for supply chain vulnerabilities.
...
Return results as JSON with this structure:
{
  "findings": [
    ...
    constructor(model, reachabilityThreshold = 'high') {
        this.model = model;
    ...
    async analyze(vulns, diff) {
        ...
        try {
            ...
            phase1Results = new Map(vulns.map(v => [
                v.package_name || '',
                {
        ...
        for (const vuln of vulns) {
            ...
            if (finalVerdict) {
                findings.push({
                    ...
                    vulnerability: vuln,
                    reachability: mapVerdict(finalVerdict.reachability),
