...
class MockScannerAdapter {
    vulnsToReturn;
    shouldThrow;
    constructor(vulnsToReturn = [], shouldThrow = false) {
        this.vulnsToReturn = vulnsToReturn;
 ...
 */
function createMockScaHunter(findingsToReturn = []) {
    return {
 ...
 */
function createPackageLockDiff(packageVersions) {
