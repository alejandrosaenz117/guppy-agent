...
export const FindingSchema = z.object({
  ...
  fix_snippet: z.string().max(3000).optional().describe('Rewritten version of the vulnerable code that mitigates the issue — drop-in replaceable, not pseudocode. REQUIRED for all findings.'),
